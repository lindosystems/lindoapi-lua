...
Generate a bin packing instance for LINGO with random weights and tight capacity.
  ...
  -o,--output   (default "./prob/gen/bin_packing.lng")  Output file name
...
if not file then
    error("Could not open output file: " .. args.output)
end
file:write("MODEL:\n")
file:write("! Bin Packing Problem Generated by lsgen_lingo_binpack.lua\n(https://github.com/lindosystems/lindoapi-lua);\n")
